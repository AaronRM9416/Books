CREATE DATABASE  IF NOT EXISTS `books.sql` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `books.sql`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: books.sql
-- ------------------------------------------------------
...
-- Dump completed on 2022-10-17 21:07:18
